...
public class SetDefaultAddressRequest extends BaseRequest {
	...
	public void onSuccess(int statusCode, String content) {
		...
		if (null != baseObject
			...
			msg = mHandler.obtainMessage(
					HandleAction.HttpType.HTTP_SET_DEFAULT_ADDRESS_SUCC,
					Integer.parseInt(contactMechId), 0, "设置成功");
		} else {
			msg = mHandler.obtainMessage(
					HandleAction.HttpType.HTTP_SET_DEFAULT_ADDRESS_FAIL,
					null != baseObject ? baseObject.errorMessage : "设置失败");
		}
	...
	public void onFailure(int statusCode, String content, Throwable error) {
		...
		Message msg = mHandler.obtainMessage(
				HandleAction.HttpType.HTTP_SET_DEFAULT_ADDRESS_FAIL, "设置失败");
		mHandler.sendMessage(msg);
	}

...
public class RefundOrderRequest extends BaseRequest {
	...
	public void onSuccess(int statusCode, String content) {
		...
		if (baseObject != null
			...
			msg = mHandler
					.obtainMessage(HandleAction.HttpType.HTTP_REFUND_ORDER_SUCC);
		} else {
			msg = mHandler
					.obtainMessage(HandleAction.HttpType.HTTP_REFUND_ORDER_FAIL);
	...
	public void onFailure(int statusCode, String content, Throwable error) {
		...
		Message msg = mHandler.obtainMessage(
				HandleAction.HttpType.HTTP_REFUND_ORDER_FAIL, "请求失败");
		mHandler.sendMessage(msg);
	}

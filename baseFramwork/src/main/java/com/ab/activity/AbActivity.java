...
public abstract class AbActivity extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ab_base.setBackgroundColor(getResources().getColor(
		...
		if (AndroidVersionCheckUtils.hasKitKat()) {
			...
			mAbTitleBar.setTitleBarHeight((int) AbViewUtil.dip2px(this, 60f));
			mAbTitleBar.setPadding(0, (int) AbViewUtil.dip2px(this, 20), 0, 0);
		} else {
			mAbTitleBar.setTitleBarHeight((int) AbViewUtil.dip2px(this, 45f));
		}
	}

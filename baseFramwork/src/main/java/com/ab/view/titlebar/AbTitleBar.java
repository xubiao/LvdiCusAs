...
public class AbTitleBar extends LinearLayout {
	...
	/** 左侧的Logo图标View. */
	protected TextView logoText = null;
	...
	public void ininTitleBar(Context context) {
		int padding = (int) AbViewUtil.dip2px(getContext(), 10);
		...
		layoutParamsFF.leftMargin = padding;
		layoutParamsFF.rightMargin = padding;
		...
		leftViewLayoutParams = new LinearLayout.LayoutParams(
				LayoutParams.WRAP_CONTENT, LayoutParams.FILL_PARENT);
		...
		AbViewUtil.setTextSize(titleTextBtn, 38);
		titleTextBtn.setPadding(0, 0, 0, 0);
		titleTextBtn.setGravity(Gravity.CENTER_VERTICAL);
		titleTextBtn.setBackgroundDrawable(null);
		titleTextBtn.setMaxLines(1);
		titleTextBtn.setEllipsize(TruncateAt.END);
		LayoutParams titleTextLp = new LinearLayout.LayoutParams(
				LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT, 1);
		titleTextLp.setMargins(25, 0, 25, 0);
		titleTextLayout.addView(titleTextBtn, titleTextLp);
		...
		LayoutParams logoLp = new LinearLayout.LayoutParams(
				LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
		logoLp.gravity = Gravity.CENTER_VERTICAL;
		logoLp.leftMargin = padding;
		logoLp.rightMargin = padding;

		LayoutParams logo2Lp = new LinearLayout.LayoutParams(
				LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
		logo2Lp.gravity = Gravity.CENTER_VERTICAL;
		logo2Lp.leftMargin = padding;
		logo2Lp.rightMargin = padding;
		...
		leftLayout.addView(logoView, logoLp);
		leftLayout.addView(logoText, logoLp);

		leftLayout.addView(logoLineView, layoutParamsWW);
		leftLayout.addView(logoView2, logo2Lp);
		...
		logoText.setTextColor(Color.parseColor("#ffffff"));
		AbViewUtil.setTextSize(logoText, 35);
	...
	public void setTitleTextSize(int titleTextSize) {
		this.titleTextBtn.setTextSize(TypedValue.COMPLEX_UNIT_PX,
				AbViewUtil.scaleTextValue(activity, titleTextSize));
	}

	/**
	 * 描述：小标题文字字号.
	 * 
	 * @param titleSmallTextSize
	 *            文字字号
	 */
	public void setTitleSmallTextSize(int titleSmallTextSize) {
		this.titleSmallTextBtn.setTextSize(TypedValue.COMPLEX_UNIT_PX,
				AbViewUtil.scaleTextValue(activity, titleSmallTextSize));
	}

	/**
	 * 描述：设置标题文字对齐方式 根据右边的具体情况判定方向： （1）标题在中间 Gravity.CENTER,Gravity.CENTER
	...
	public void setTitleBarGravity(int gravity1, int gravity2) {
		...
		// AbViewUtil.measureView(this.logoView2);
		AbViewUtil.measureView(this.rightLayout);
		int leftWidth = 0;
		int rightWidth = 0;
		// if (leftLayout.getVisibility() == View.VISIBLE) {
		leftWidth += (this.leftLayout.getMeasuredWidth());
		// }
		// if (logoView2.getVisibility() == View.VISIBLE) {
		// leftWidth += (this.logoView2.getMeasuredWidth() + 20);
		// }

		// if (rightLayout.getVisibility() == View.VISIBLE) {
		rightWidth += (this.rightLayout.getMeasuredWidth());
		// }
	...
	public void setLogoTextSizeSp(int textSize) {
		AbViewUtil.setTextSizeSp(logoText, textSize);
	}
	...
	public void setTitleLayoutOrientation(int orientation) {
		titleTextLayout.setOrientation(orientation);
	}
	...
	public void setCompoundDrawables(Drawable left, Drawable top,
		...
		titleTextBtn.setCompoundDrawables(left, top, right, bottom);
	}
	 ...
	 * 
	 * @param height
	 *            LayoutParams属性 和具体的大小px
	 */
	public void setTitleBarHeight(int height) {
		ViewGroup.LayoutParams params = this.getLayoutParams();
		params.height = height;// AbViewUtil.scaleValue(activity, height);
